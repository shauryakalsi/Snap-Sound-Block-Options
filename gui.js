    ...
    addPreference(
        ...
        function () {
            ...
            if (BlockMorph.prototype.snapSound) {
                ...
                // edit the above to incorporate a menu
            } else {
...
IDE_Morph.prototype.userClickingSoundMenu = function () {
    ...
    var menu = new MenuMorph(this),
        ...
        myself = this;
    var soundsArr = [];
    soundsArr.push("click");
    soundsArr.push("arrow");
    soundsArr.push("laugh1");
    soundsArr.push("laugh2");
    soundsArr.push("laugh3");
...
IDE_Morph.prototype.setClickingSound = function (sounddd) {

    
    //var chosensound = document.getElementById('audio'),
        if (sounddd == "no sound") {
            BlockMorph.prototype.snapSound.src = null;    
        }
        else {
            BlockMorph.prototype.snapSound.src = sounddd + '.wav'
        }
        //myself = this;
};
